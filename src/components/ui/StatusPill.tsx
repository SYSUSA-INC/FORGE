const MAP: Record<string, string> = {
  PLANNING: "border-layer/15 bg-layer/5 text-muted",
  OUTLINING: "border-layer/15 bg-layer/5 text-muted",
  ...
  PRODUCTION: "border-layer/20 bg-layer/10 text-text",
  ...
  INFORMATIONAL: "border-layer/15 bg-layer/5 text-muted",
  ...
  "N/A": "border-layer/15 bg-layer/5 text-muted",

  CRITICAL: "border-rose/40 bg-rose/15 text-rose",
  MAJOR: "border-gold/40 bg-gold/15 text-gold",
  MINOR: "border-layer/15 bg-layer/5 text-muted",
  SUGGESTION: "border-layer/15 bg-layer/5 text-muted",
...
export function StatusPill({ value }: { value: string }) {
  const tone = MAP[value] ?? "border-layer/15 bg-layer/5 text-muted";
  return (
    <span
