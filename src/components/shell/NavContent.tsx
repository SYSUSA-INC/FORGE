...
const NAV = [
  ...
  { href: "/opportunities", label: "Opportunities", icon: "✸", group: "ops", admin: false, superadmin: false },
  ...
  { href: "/settings/email", label: "Email senders", icon: "✉", group: "admin", admin: false, superadmin: false },
