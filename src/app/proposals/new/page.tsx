    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_1fr]">
        <Panel title="LINK SOLICITATION" code="SOL" accent="cobalt">
          <ul className="flex flex-col gap-2">
            {solicitations.slice(0, 4).map((s) => (
              <li
                key={s.id}
                className="grid grid-cols-[1fr_100px] items-center gap-2 border-2 border-ink bg-paper p-3"
              >
                <div>
        ...
        <Panel title="PROPOSAL CONFIG" code="CFG" accent="hazard">
          ...
          <div className="mt-4 border-2 border-ink bg-bone p-3 font-mono text-[11px]">
