...
| 3b | **BL-PACKAGES Slice 2** — Migrate 7 lib-helper AI callers | P1 | M | 🟡 in progress (this PR) — all tenant AI paths now token-capped |
| 3c | **BL-PACKAGES Slice 3** — Super-admin usage panel: per-tenant token consumption | P1 | M | ⏳ queued |
